...
class ComZeappsCrmOrderCompaniesTable extends Migration
{

    public function up()
    {
       Capsule::schema()->create('com_zeapps_crm_order_companies', function (Blueprint $table) {
            $table->increments('id');
            ...
            $table->string('name_type_account')->default("");
    ...
    {
        Capsule::schema()->dropIfExists('com_zeapps_crm_order_companies');
    }
}
