...
class ComZeappsCrmUpdateAddress
{
    ...
    public function up()
    {
        Capsule::schema()->table('com_zeapps_crm_quotes', function (Blueprint $table) {
            $table->string('delivery_name_company', false, true)->after('id_company_address_delivery')->default("");
            $table->string('delivery_name_contact', false, true)->after('id_contact_address_delivery')->default("");
        });
