...
class ComZeappsCrmOrderLinesTable extends Migration
{

    public function up()
    {
        Capsule::schema()->create('com_zeapps_crm_order_lines', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Capsule::schema()->dropIfExists('com_zeapps_crm_order_lines');
    }
}
