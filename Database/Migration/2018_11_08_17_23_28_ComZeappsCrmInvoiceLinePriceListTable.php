...
class ComZeappsCrmInvoiceLinePriceListTable extends Migration
{

    public function up()
    {
        Capsule::schema()->create('com_zeapps_crm_invoice_line_price_list', function (Blueprint $table) {
            $table->increments('id');
            $table->integer('id_invoice_line')->default(0);
    ...
    {
        Capsule::schema()->dropIfExists('com_zeapps_crm_invoice_line_price_list');
    }
}
