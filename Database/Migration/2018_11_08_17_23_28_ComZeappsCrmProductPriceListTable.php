...
class ComZeappsCrmProductPriceListTable extends Migration
{

    public function up()
    {
        Capsule::schema()->create('com_zeapps_crm_product_price_list', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Capsule::schema()->dropIfExists('com_zeapps_crm_product_price_list');
    }
}
