...
class ComZeappsCrmQuoteContactsTable extends Migration
{

    public function up()
    {
        Capsule::schema()->create('com_zeapps_crm_quote_contacts', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Capsule::schema()->dropIfExists('com_zeapps_crm_quote_contacts');
    }
}
