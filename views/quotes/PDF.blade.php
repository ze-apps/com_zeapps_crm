    ...
    <table>
        ...
        <tr>
            <td id="delivery_address">
                ...
                <?php
                if ($quote->delivery_address_full_text != "") {
                    echo nl2br($quote->delivery_address_full_text) . '<br>';
                } else {
            ...
            <td id="billing_address">
                ...
                <?php
                if ($quote->billing_address_full_text != "") {
                    echo nl2br($quote->billing_address_full_text) . '<br>';
                } else {
...
<table>
    <tr>
        ...
        <td class="text-right">
            <?php if(floatval($quote->total_discount_ht) > 0){ ?>
            <table class="total">
                <tr>
                    <td class="text-left">
                        Total HT av remise
                ...
                <tr>
                    ...
                    <td class="text-right">
                        <?php echo number_format(floatval($quote->total_discount_ht), 2, ',', ' ') ?: '0,00'; ?>
                    </td>
                </tr>
                <tr>
                    <td class="text-left">
                    ...
                    <td class="text-right">
                        <?php echo number_format(floatval($quote->total_discount_ttc), 2, ',', ' ') ?: '0,00'; ?>
                    </td>
                </tr>
            </table>
            <?php }?>
