...
<div id="content">
    ...
    <form>
            ...
            <div class="row">
                <div class="col-md-2">
                    <div class="titleWell" style="font-weight: bold;">
                        {{ __t("Invoice") }} : @{{ invoice.libelle }}
                    </div>
                    <p class="small" style="font-weight: bold; font-size: 1.2em;">
                        {{ __t("No.") }} @{{ invoice.numerotation }}
                    </p>
                ...
                <div class="col-md-3">
                    ...
                    <div ng-hide="invoice.billing_address_full_text">
                        <a href="/ng/com_zeapps_contact/companies/@{{ company.id }}">@{{ invoice.name_company }}</a><br
                                ng-if="invoice.name_company">
                        <a href="/ng/com_zeapps_contact/contacts/@{{ contact.id }}">@{{ invoice.name_contact }}</a><br
                                ng-if="invoice.name_contact">
                ...
                <div class="col-md-3">
                    ...
                    <div ng-hide="invoice.delivery_address_full_text">
                        <a href="/ng/com_zeapps_contact/companies/@{{ company.id }}">@{{ invoice.delivery_name_company
                            }}</a><br ng-if="invoice.delivery_name_company">
                        <a href="/ng/com_zeapps_contact/contacts/@{{ contact.id }}">@{{ invoice.delivery_name_contact
                            }}</a><br
                                ng-if="invoice.delivery_name_contact">
                ...
                <div class="col-md-4" style="text-align: right">
                    <div class="row">
                            ...
                            <div>
                                ...
                                @if (in_array("com_zeapps_crm_write", $zeapps_right_current_user))
                                    <ze-btn fa="edit" color="info" hint="{{ __t("Edit") }}" direction="left"
                                            ...
                                            data-title="{{ __t("Modify the invoice") }}"
                                ...
                                @if (in_array("com_zeapps_crm_write", $zeapps_right_current_user))
                                    ...
                                    <ze-btn fa="lock" color="danger" hint="{{ __t("Close") }}" direction="left" ng-click="finalize()"
                                            ng-hide="invoice.finalized"></ze-btn>
                                @endif
                        ...
                        <div class="col-md-12">
                            <div class="pull-right" style="margin-top: 50px;">{{ __t("Weight") }} : @{{ invoice.weight | weight }}</div>
                        </div>

                        <div class="col-md-12">
                            <div ng-include="hook.template" ng-repeat="hook in hooksComZeappsCRM_InvoiceHeaderRightHook"
                                ...
                                <td class="text-right">
                                        <span ng-if="line.type === 'product' || line.type === 'service' || line.type === 'pack'">
                                            <ze-btn fa="edit" color="info" direction="left" hint="{{ __t("Edit") }}"
                                                    ...
                                                    data-edit="line"
                                                    data-title="{{ __t("Edit the invoice line") }}"
                                    ...
                                    <ze-btn fa="trash" color="danger" direction="left" hint="{{ __t("Delete") }}"
                                            ...
                                            ng-if="line && !invoice.finalized"></ze-btn>
                                </td>
                            @endif
                        </tr>
                        </tbody>
                ...
                <div class="col-md-5 col-md-offset-2 divPrice">
                    <div class="well well-sm">
                        <div ng-if="invoice.total_discount > 0">
                            <div class="row">
                                ...
                                <div class="col-md-6 text-right">
                                    @{{ invoice.total_prediscount_ht | currencyConvert }}
                                </div>
                            </div>
                            <hr>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 text-right">
                                    @{{ invoice.total_discount_ht | currencyConvert }}
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 text-right">
                                    @{{ invoice.total_discount_ttc | currencyConvert }}
                                </div>
                            </div>
                        ...
                        <div class="row total">
                            ...
                            <div class="col-md-6 text-right">
                                @{{ invoice.total_ht | currencyConvert }}
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 text-right">
                                @{{ invoice.total_tva | currencyConvert }}
                            </div>
                        </div>
                        ...
                        <div class="row total">
                            ...
                            <div class="col-md-6 text-right">
                                @{{ invoice.total_ttc | currencyConvert }}
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div ng-show="navigationState=='header'">
            ...
            @{{ invoice.date_creation | dateConvert:'date' }}
            <br/>
            <strong>{{ __t("Validity date") }} :</strong>
            @{{ invoice.date_limit | dateConvert:'date' }}
            <br/>
        </div>
                    ...
                    <table class="table table-responsive table-condensed" ng-show="documents.length">
                        ...
                        <tbody>
                            <tr ng-repeat="document in documents | orderBy:['-date','-id']">
                                ...
                                <td class="text-right">
                                    @if (in_array("com_zeapps_crm_write", $zeapps_right_current_user))
                                    <ze-btn data-fa="edit" data-hint="{{ __t("Edit") }}" data-direction="left" data-color="info" ze-modalform="editDocument" data-edit="document" data-template="invoiceDocumentTplUrl" data-title="{{ __t("Edit document") }}"></ze-btn>
        ...
        <div ng-if="navigationState=='email'">
            <div ng-include="'/zeapps/email/list_partial'"
                 ng-init="module = 'com_zeapps_crm'; id = 'invoices_' + invoice.id"></div>
        </div>
