...
<div id="content">
    ...
    <form>
                ...
                <div class="col-md-5 col-md-offset-2 divPrice">
                    <div class="well well-sm">
                        <div ng-if="delivery.total_discount > 0">
                            <div class="row">
                                ...
                                <div class="col-md-6 text-right">
                                    @{{ delivery.total_prediscount_ht | currencyConvert }}
                                </div>
                            </div>
                            <hr>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 text-right">
                                    @{{ delivery.total_discount_ht | currencyConvert }}
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 text-right">
                                    @{{ delivery.total_discount_ttc | currencyConvert }}
                                </div>
                            </div>
                        ...
                        <div class="row total">
                            ...
                            <div class="col-md-6 text-right">
                                @{{ delivery.total_ht | currencyConvert }}
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 text-right">
                                @{{ delivery.total_tva | currencyConvert }}
                            </div>
                        </div>
                        ...
                        <div class="row total">
                            ...
                            <div class="col-md-6 text-right">
                                @{{ delivery.total_ttc | currencyConvert }}
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div ng-show="navigationState=='header'">
            ...
            @{{ delivery.date_creation | dateConvert:'date' }}
            <br/>
        </div>
