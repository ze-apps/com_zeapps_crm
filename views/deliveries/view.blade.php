                ...
                <div class="col-md-4">
                    <div class="pull-right">
                        ...
                        <div class="btn-group btn-group-xs" role="group" ng-if="nb_deliveries > 0">
                            ...
                            <button type="button" class="btn btn-default disabled">@{{delivery_deliverie}}/@{{nb_deliveries}}</button>
                ...
                <div class="col-md-12">
                    <table class="table table-responsive table-condensed">
                        ...
                        <tr ng-repeat="credit in credits">
                            <td><a href="/ng/com_zeapps_crm/delivery/@{{credit.id_delivery}}">@{{ credit.numerotation }}</a></td>
