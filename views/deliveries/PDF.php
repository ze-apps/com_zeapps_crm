...
<table class="root">
    ...
    <tr>
        <td id="delivery_address">
            ...
            <?php
            echo $deliverie->name_company . '<br>';
            echo $deliverie->last_name . '<br>';
            echo $deliverie->delivery_address_1;
            echo $deliverie->delivery_address_2 ? '<br>' : '';
            echo $deliverie->delivery_address_2;
            echo $deliverie->delivery_address_3 ? '<br>' : '';
            echo $deliverie->delivery_address_3;
            echo '<br>';
            echo $deliverie->delivery_zipcode . ' ' . $deliverie->delivery_city;
            ?>
        </td>
        <td id="billing_address">
            ...
            echo $deliverie->name_company . '<br>';
            echo $deliverie->last_name . '<br>';
            echo $deliverie->billing_address_1;
            echo $deliverie->billing_address_2 ? '<br>' : '';
            echo $deliverie->billing_address_2;
            echo $deliverie->billing_address_3 ? '<br>' : '';
            echo $deliverie->billing_address_3;
            echo '<br>';
            echo $deliverie->billing_zipcode . ' ' . $deliverie->billing_city;
            ?>
        </td>
    </tr>
    <tr>
        <td colspan="2" class="object">
            <strong>Objet : <?php echo $deliverie->libelle; ?></strong>
        </td>
    </tr>
    <tr>
        <?php if($deliverie->modalities !== ""){ ?>
        <td class="bdeliverie">
            <strong>Mode de reglement</strong><br>
            <?php echo $deliverie->modalities; ?>
        </td>
        <?php } ?>
        <?php if($deliverie->date_limit !== "0000-00-00 00:00:00"){ ?>
        <td class="bdeliverie">
            <strong>Date de validité</strong><br>
            <?php  echo date('d/m/Y', strtotime($deliverie->date_limit)); ?>
        </td>
        <?php } ?>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td class="text-right">
                <?php if(floatval($deliverie->total_discount) > 0){ ?>
                <table class="total">
                    <tr>
                        <td class="text-left">
                            Total HT av remise
                        ...
                        <td class="text-right">
                            <?php echo number_format(floatval($deliverie->total_prediscount_ht), 2, ',', ' '); ?>
                        </td>
                    </tr>
                    <tr>
                        <td class="text-left">
                        ...
                        <td class="text-right">
                            <?php echo number_format(floatval($deliverie->total_prediscount_ttc), 2, ',', ' '); ?>
                        </td>
                    </tr>
                    <?php if(floatval($deliverie->global_discount) > 0){ ?>
                    <tr>
                        <td class="text-left">
                            Remise globable
                        </td>
                        <td class="text-right">
                            <?php echo number_format(floatval($deliverie->global_discount), 2, ',', ' ') . '%'; ?>
                        </td>
                    </tr>
                    <?php } ?>
                    <tr>
                        ...
                        <td class="text-right">
                            <?php echo number_format(floatval($deliverie->total_discount), 2, ',', ' ') ? : '0,00'; ?>
                        </td>
                    </tr>
                </table>
                <?php }?>
            <table class="total">
                <tr>
                    ...
                    <td class="text-right">
                        <?php echo number_format(floatval($deliverie->total_ht), 2, ',', ' '); ?>
                    </td>
                </tr>
                <tr>
                    <td class="text-left">
                    ...
                    <td class="text-right">
                        <?php echo number_format(floatval($deliverie->total_tva), 2, ',', ' '); ?>
                    </td>
                </tr>
                <tr>
                    <td class="text-left">
                    ...
                    <td class="text-right">
                        <?php echo number_format(floatval($deliverie->total_ttc), 2, ',', ' '); ?>
                    </td>
                </tr>
            </table>
            Prix en euros
