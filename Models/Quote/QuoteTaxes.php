...
class QuoteTaxes extends Model
{
    static protected $_table = 'com_zeapps_crm_quote_taxes';
    protected $table;
    ...
    public static function getAccountingFromQuote($id_quote) {
        return self::where("id_quote", $id_quote)->get() ;
    }

    public static function getTableTaxe($id_quote) {
        $arrTaxes = [];

        $accountingLines = self::getAccountingFromQuote($id_quote);
