...
class InvoiceLinePriceList extends Model
{
    use SoftDeletes;

    static protected $_table = 'com_zeapps_crm_invoice_line_price_list';
    protected $table;
    ...
    public function __construct(array $attributes = [])
    {
        ...
        $this->fieldModelInfo->integer('id_invoice_line')->default(0);
