    ...
    function ($routeProvider) {
        $routeProvider
            ...
            .when("/ng/com_zeapps_crm/model_email", {
                ...
                controller: "ComZeappsCrmModelEmailConfigCtrl"
            })

			.when("/ng/com_zeapps_crm/model_email/new", {
				templateUrl: "/com_zeapps_crm/model_email/form",
				controller: "ComZeappsCrmModelEmailConfigFormCtrl"
			})

			.when("/ng/com_zeapps_crm/model_email/edit/:id", {
				templateUrl: "/com_zeapps_crm/model_email/form",
				controller: "ComZeappsCrmModelEmailConfigFormCtrl"
			})
